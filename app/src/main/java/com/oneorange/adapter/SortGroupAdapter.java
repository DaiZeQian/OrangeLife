 ...
 * @author Lyy
 */
public class SortGroupAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public SortGroupAdapter(Context mContext, List<SortModel> list) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_group_sortbar, null);
        ...
        viewHolder.tv_num.setText(this.list.get(position).getNum());
        viewHolder.tvTitle.setText(this.list.get(position).getName());
        ImageLoader.getInstance().displayImage("", viewHolder.iv_icon, options);
        return view;
