 ...
 * @author Lyy
 */
public class SortChooseAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public SortChooseAdapter(Context mContext, List<SortModel> list) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.item_choose_sortbar, null);
        ...
        if (this.list.get(position).isChoose()) {
            viewHolder.iv_choose.setImageResource(R.mipmap.choose_on);
        } else {
            viewHolder.iv_choose.setImageResource(R.mipmap.choose_off);
        }
